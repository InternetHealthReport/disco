...
if __name__ == "__main__":
    ...
    plotter.plotHeatMap(ref,refFTR,'figures/heatMapTRR',xlabel='TRR_Ref_Succ',ylabel='TRR_Ref_Unsucc')

    plotter.suffix='CalBoth'
    ...
    plotter.plotHeatMap(cal,calFTR,'figures/heatMapTRR',xlabel='TRR_Cal_Succ',ylabel='TRR_Cal_Unsucc')
